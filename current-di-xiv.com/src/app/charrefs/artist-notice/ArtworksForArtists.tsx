...
const LoadingSpinner: React.FC<{ message: string }> = ({ message }) => (
  <div className="flex justify-center regular">
    ...
    <div className="justify-center dark:invert inline-block">
      <svg
        xmlns="http://www.w3.org/2000/svg"
        className="h-8 w1366:h-6 mobile-only:h-8 w-auto select-none dark:invert inline-block mr-2"
        viewBox="0 0 24 24"
      >
...
const ArtworksForArtists: React.FC<Props> = ({
  ...
  if (artworks.length === 0 && !loading && !error) {
    return null;
  }
